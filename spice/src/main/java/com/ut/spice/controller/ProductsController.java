...
public class ProductsController {
	...
	public ResponseEntity<Products> getProductDesceriptionEnglish(@PathVariable int pid, @PathVariable String pEngDesc) {
		
		Products products = productsRepository.findByProductDescriptionEnglishContainingAndId(pEngDesc, pid).get(0);
